...
def FixPatientID():
    ...
    def info_function(path_dicoms,old_name,new_ID):
        ...
        os.rename(path_dicoms + "\\" + old_name + ".dcm",path_dicoms + "\\" + new_ID + ".dcm")
        a = "Patient ID and file name were changed to: " + str(new_ID)
        b = "You can continue to change other file patient ID \n without restart the application"
        label2 = tk.Label(frame, text = a,bg="#FFFBD2",font=("Arial", 13), fg ="black")
        label2.place(relx=0.05,rely=0.73,relwidth =0.9, relheight=0.08)
        label3 = tk.Label(frame, text = b,bg="#FFFBD2",font=("Arial", 13), fg ="black")
    ...
    label0 = tk.Label(frame, text = "Fix-Patient-ID", 
    ...
    new_ID = tk.Label(frame, text = "New PatientID:", 
                     bg=BG,font=("Arial", 12), fg ="black")
