# -*- coding: utf-8 -*-
"""
Created on Mon Dec 20 15:15:01 2021
...
def FixPatientNameMass():
    ...
    def info_function(path_dicoms):
        ...
        for s in info_data.SN:
            ...
            z.PatientName = str(info_data.PatientName[s])
    ...
    root = tk.Tk()
    root.title('FixPatientName-Mass')
